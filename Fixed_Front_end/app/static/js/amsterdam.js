...
function createDrawnPolygon(dropdownSelection) {
  ...
  for (m=0; m<data.features.length; m++) {
    ...
    //complete_polygon_data.push
	//countFeatures(polygon, dropdownSelection);
   // console.log(complete_polygon_data);
 
  };
  var counts_array = [];
  var counts_object = {};
  console.log("comes into promise");
  var d3Action = new Promise(function(resolve,reject){
  dropdownSelection.forEach(function(listItem){
...
d3Action.then(function (counts_array){
	...
	console.log(counts_array.length);
	console.log(counts_array[0]);
	console.log(counts_array[2]);
	console.log(counts_array[1]['marker']);
});
